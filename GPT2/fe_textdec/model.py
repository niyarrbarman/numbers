"""
GPT-2 with Number Embedding Integration (TEXT output) — UNFROZEN ENCODER.
...
are predicted as plain text BPE tokens through the standard lm_head —
no SME encoding, no constrained decoding.
