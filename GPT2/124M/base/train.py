...
# I/O
out_dir = '/tmpdir/m24047brmn/numbers/model_checkpoints/124M_base'
eval_interval = 5000
log_interval = 1
eval_iters = 200
...
lr_decay_iters = 40000 # should match max_iters for a full cosine schedule
