...
# ===========================================================================
# Step 1: Stage 1 — Data Generation (CPU)
# ===========================================================================
...
# ===========================================================================
# Step 2: Stage 1 — Training (GPU, afterok:1)
# ===========================================================================
...
# ===========================================================================
# Step 3: Stage 2 — Data Generation (CPU, parallel with S1)
# ===========================================================================
...
# Generate synth arithmetic data (base + adapted variants)
...
# Generate arithmetic benchmark data if not present
...
# ===========================================================================
# Step 4a: Stage 2 — Base LoRA (GPU, afterok:3)
#   Plain Luciole, no number encoder, 10k steps
# ===========================================================================
...
# ===========================================================================
# Step 4b: Stage 2 — Analytic-Adapter LoRA (GPU, afterok:2,3)
#   Uses Stage 1 checkpoint (adapter + decoder weights), 10k steps
# ===========================================================================
