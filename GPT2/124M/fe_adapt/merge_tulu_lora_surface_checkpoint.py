"""Merge an intermediate surface LoRA checkpoint into a standalone checkpoint.

Usage:
  python merge_tulu_lora_surface_checkpoint.py \
...
def main():
    parser = argparse.ArgumentParser(description='Merge surface LoRA checkpoint')
