...
This script loads a checkpoint produced by 124M/fe/train.py and evaluates
...
def main() -> None:
    p = argparse.ArgumentParser(description="Validate full val set for 124M FE (text-decode) checkpoint")
    ...
    print("=" * 70)
    print("124M FE Text-Decode Checkpoint Validation (Full Val Set)")
    print("=" * 70)
    ...
    print(f"Blend beta infer: {model_args.get('num_blend_beta_infer', 'N/A')}")
    print(f"Norm match:       {model_args.get('num_norm_match', 'N/A')}")
    ...
    # Forward passes — model defaults to config blend_beta and norm_match
