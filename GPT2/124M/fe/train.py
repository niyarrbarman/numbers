"""
Training script for number-aware GPT-2 (TEXT output) — 124M scale.
...
Output numbers are predicted as plain text BPE tokens.
...
# I/O
out_dir = '/tmpdir/m24047brmn/numbers/model_checkpoints/124M_fe'
eval_interval = 5000
log_interval = 1
diag_interval = 100
